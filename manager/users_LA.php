...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Late and Absent</h5>
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td class="border-bottom-0">
                      <a href="emp_late.php?user_id=<?=$user_id;?>" class="badge btn bg-primary rounded-3 fw-semibold">Late</a>
                      <a href="emp_absent.php?user_id=<?=$user_id;?>" class="badge btn bg-primary rounded-3 fw-semibold">Absent</a>
                    </td>
                  </tr>
                  <?php
                     endforeach;
