          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                 ...
                 ?> 
                <p><strong>New Manager Account</strong></p>
                <form method="post" action="navigate.php">
                  ...
                  <button class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" type="submit" name="btn-add-manager">Create Account</button>
                </form>
              </div>
            </div>
          </div>
