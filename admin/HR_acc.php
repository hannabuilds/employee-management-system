          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                ?> 
                <p><strong>New HR Account</strong></p>
                <form method="post" action="navigate.php">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="exampleInputTask" name="task" required>
                  </div>
                  <div class="mb-5">
                    <label for="exampleInputPassword" class="form-label">Password</label>
                    <input type="password" class="form-control" id="exampleInputPassword" name="password" required>
                  </div>
                  <button class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" type="submit" name="btn-add-HR">Create Account</button>
                </form>
              </div>
            </div>
          </div>
