                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="border-bottom-0">
                      ...
                      <a href="emp_salary.php?user_id=<?=$user_id;?>" class="badge btn bg-warning rounded-3 fw-semibold">Salary</a> &nbsp;
                      <input type="hidden" name="emp_acc_ID" value="<?=$user_id;?>">
                      <a href="salary_view.php?user_id=<?=$user_id;?>" class="badge btn bg-info rounded-3 fw-semibold">View</a>
                    </form>
                    </td>
                  </tr>
