                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="border-bottom-0">
                      ...
                      <a href="emp_profile.php?user_id=<?=$user_id;?>" class="badge btn bg-success rounded-3 fw-semibold">View</a>
                      <a href="emp_update.php?user_id=<?=$user_id;?>" class="badge btn bg-primary rounded-3 fw-semibold">Update</a> &nbsp;
