...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Late and Overtime</h5>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="border-bottom-0">
                      <a href="emp_otRate.php?user_id=<?=$user_id;?>" class="badge btn bg-success rounded-3 fw-semibold">OT Rate</a>
                    </td>
                  </tr>
