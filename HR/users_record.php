...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Time in/out</h5>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="border-bottom-0">
                      <a href="emp_attendance.php?user_id=<?=$user_id;?>" class="badge btn bg-warning rounded-3 fw-semibold">Attendance</a> &nbsp;
                      <input type="hidden" name="emp_acc_ID" value="<?=$user_id;?>">
                      <a href="emp_record.php?user_id=<?=$user_id;?>" class="badge btn bg-info rounded-3 fw-semibold">View</a>
                    </td>
                  </tr>
                  <?php
                     endforeach;
